...
| 5 | **All 6,960 tests must pass** - no skips, no deletions | `.skip()`, `.only()`, deleting tests |
...
3. `npm test` - All 6,960 tests must pass
...
- **Tests**: 6,960 tests across 278 suites (100% pass rate, 0 skipped)
