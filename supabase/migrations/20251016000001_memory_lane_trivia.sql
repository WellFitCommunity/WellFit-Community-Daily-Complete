...
-- to resolve the version-20251016000001 drift (was colliding with
-- medicine_cabinet.sql in the local repo).
--
-- This is the v1 of the trivia schema. A later v2 with refinements
-- lives at supabase/migrations/20251017000003_memory_lane_trivia.sql.
