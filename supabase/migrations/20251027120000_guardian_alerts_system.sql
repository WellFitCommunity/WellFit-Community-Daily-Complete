...
CREATE TABLE IF NOT EXISTS guardian_alerts (
  ...
  session_recording_id TEXT REFERENCES session_recordings(session_id),
  ...
  acknowledged_by TEXT REFERENCES auth.users(id),
...
CREATE TABLE IF NOT EXISTS security_notifications (
  ...
  read_at TIMESTAMPTZ,
  read_by TEXT REFERENCES auth.users(id)
);
...
-- INSERT INTO guardian_alerts (id, severity, category, title, description, actions, metadata)
-- VALUES (
--   'alert-test-1',
--   'warning',
--   'security_vulnerability',
--   'XSS Vulnerability Detected',
--   'Cross-site scripting vulnerability found in UserProfileComponent.tsx',
--   '[
--     {"id": "view", "label": "View Code", "type": "view_recording", "url": "/security/code-review/UserProfileComponent.tsx"},
--     {"id": "dismiss", "label": "Dismiss", "type": "dismiss", "confirmation_required": true}
--   ]'::jsonb,
--   '{"auto_healable": true, "estimated_impact": "Medium security risk"}'::jsonb
-- );
