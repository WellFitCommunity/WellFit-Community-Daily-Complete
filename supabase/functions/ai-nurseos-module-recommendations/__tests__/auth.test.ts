// supabase/functions/ai-nurseos-module-recommendations/__tests__/auth.test.ts
//
// Tests for the authorization gate added to ai-nurseos-module-recommendations.
// The bug: every authenticated nurse could fetch a different provider's module
// recommendations (derived from PHI burnout assessments + check-ins) across every
// tenant. The fix: self-access OR admin role + tenant match.
//
...
Deno.test("module-recommendations authorization gate", async (t) => {
