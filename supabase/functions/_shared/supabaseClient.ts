...
export function createSupabaseClient(
  ...
  // New key format first, legacy JWT keys as fallback for resilience
  const supabaseKey = options.useServiceRole
    ...
    : (Deno.env.get('SB_PUBLISHABLE_API_KEY') || Deno.env.get('SB_ANON_KEY') || Deno.env.get('SUPABASE_ANON_KEY'));
