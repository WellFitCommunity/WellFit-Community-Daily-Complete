// supabase/functions/ai-nurseos-burnout-advisor/__tests__/auth.test.ts
//
// Tests for the authorization gate added to ai-nurseos-burnout-advisor.
// The bug: every authenticated nurse could fetch a different provider's burnout
// data across every tenant. The fix: self-access OR admin role + tenant match.
//
...
Deno.test("burnout-advisor authorization gate", async (t) => {
