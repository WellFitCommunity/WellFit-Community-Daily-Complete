...
const mockLabConnections: LabProviderConnection[] = [
  {
    ...
    fhirBaseUrl: 'https://api.labcorp.com/fhir',
    fhirVersion: 'R4',
    authType: 'oauth2',
...
const mockPharmacyConnections: PharmacyConnection[] = [
  {
    ...
    pharmacyType: 'SURESCRIPTS',
    ncpdpId: '1234567',
    protocol: 'NCPDP_SCRIPT',
    supportsErx: true,
    supportsRefillRequests: true,
    supportsMedicationHistory: true,
...
const mockCriticalLabResults: LabResult[] = [
  {
    ...
    criticalValuesAcknowledged: false,
...
const mockCriticalImagingFindings: ImagingReport[] = [
  {
    ...
    findings: 'Suspicious mass detected in upper right lobe',
    impression: 'Mass requires further evaluation',
