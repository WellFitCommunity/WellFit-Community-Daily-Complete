...
export const MedicalCodingMCPPanel: React.FC = () => {
  ...
  return (
    <div className="space-y-4" aria-label="Medical Coding MCP Panel">
      {/* Tab Navigation */}
        ...
        <nav className="flex gap-1 -mb-px" aria-label="Medical Coding tabs">
          {TABS.map((tab) => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-3 text-sm font-medium border-b-2 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--ea-primary,#00857a)] ${
                activeTab === tab.id
