...
export const BedBoardRealTimeTab: React.FC<BedBoardRealTimeTabProps> = ({
  ...
  <div className="space-y-4" aria-label="Real-Time Bed Board">
    ...
    <div className="flex flex-wrap items-center gap-4">
      <div className="relative flex-1 max-w-xs">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-400 focus-visible:ring-2 focus-visible:ring-[var(--ea-primary)] focus-visible:border-transparent"
        />
      </div>
      ...
      <select
        ...
        className="px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white focus-visible:ring-2 focus-visible:ring-[var(--ea-primary)]"
      >
      ...
      <div className="space-y-4 mt-6">
        <EACard>
          ...
          <EACardContent className="p-0">
            <table className="w-full" aria-label="Unit capacity overview">
              <thead>
