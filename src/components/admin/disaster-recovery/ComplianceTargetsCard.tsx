    ...
    <EACard>
      <EACardHeader>
        <h3 className="font-semibold text-gray-900 flex items-center gap-2">
          <TrendingUp className="w-5 h-5 text-[var(--ea-primary)]" />
          Compliance Targets
        </h3>
      </EACardHeader>
      <EACardContent className="p-4">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <div className="text-center p-3 bg-gray-50 rounded">
            <div className="text-2xl font-bold text-[var(--ea-primary)]">15 min</div>
            <div className="text-sm text-gray-500">RPO Target</div>
          </div>
          <div className="text-center p-3 bg-gray-50 rounded">
            <div className="text-2xl font-bold text-[var(--ea-primary)]">4 hrs</div>
            <div className="text-sm text-gray-500">RTO Target</div>
          </div>
          <div className="text-center p-3 bg-gray-50 rounded">
            <div className="text-2xl font-bold text-[var(--ea-primary)]">95%</div>
            <div className="text-sm text-gray-500">Backup Success</div>
          </div>
          <div className="text-center p-3 bg-gray-50 rounded">
            <div className="text-2xl font-bold text-[var(--ea-primary)]">90%</div>
            <div className="text-sm text-gray-500">Drill Pass Rate</div>
          </div>
          <div className="text-center p-3 bg-gray-50 rounded">
            <div className="text-2xl font-bold text-[var(--ea-primary)]">Weekly</div>
