  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="bg-white rounded-lg shadow-sm p-4 border-l-4 border-[var(--ea-primary,#00857a)]">
      ...
      <div className="bg-white rounded-lg shadow-sm p-4">
        <div className="flex flex-wrap gap-4">
          ...
          <button
            onClick={loadEngagementData}
            className={`self-end px-4 py-2 rounded-md transition ${theme.buttonPrimary}`}
          >
            Refresh Data
          </button>
        </div>
      ...
      <div className="bg-[var(--ea-primary,#00857a)]/5 border border-[var(--ea-primary,#00857a)]/20 rounded-lg p-4">
        <h3 className="font-semibold text-slate-900 mb-2">Understanding Engagement Scores</h3>
        ...
        <div className="mt-2 text-xs text-slate-600 bg-white p-2 rounded-sm">
