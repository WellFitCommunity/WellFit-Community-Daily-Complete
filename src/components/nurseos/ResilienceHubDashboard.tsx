...
export const ResilienceHubDashboard: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      console.error('ResilienceHubDashboard load error:', err);
  ...
  return (
    <div className="resilience-hub-dashboard">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">Your wellness checkpoint — because you can't pour from an empty cup.</p>
      </div>
        ...
        <div className="flex items-center gap-4">
          <div className="flex-shrink-0">
            <span className={`inline-block px-6 py-3 rounded-full text-lg font-bold uppercase tracking-wide ${getRiskBadgeColor(stats.current_burnout_risk)}`}>
              {stats.current_burnout_risk === 'unknown' ? 'Not Assessed' : `${stats.current_burnout_risk} Risk`}
            </span>
          </div>
          <div className="flex-1">
            <p className="text-sm text-gray-600">
              {stats.current_burnout_risk === 'unknown' && 'Take a burnout assessment to get your risk level.'}
              {stats.current_burnout_risk === 'low' && 'Great! Keep up the self-care practices.'}
              {stats.current_burnout_risk === 'moderate' && 'Consider increasing self-care activities.'}
              {stats.current_burnout_risk === 'high' && 'High stress detected. Please prioritize self-care.'}
              {stats.current_burnout_risk === 'critical' && '⚠️ Critical level. Please reach out for support immediately.'}
            </p>
          </div>
        </div>
      </div>
      ...
      {stats.intervention_needed && (
        <div className="mb-6 bg-orange-50 border-l-4 border-orange-500 p-4 rounded-r-lg">
          <div className="flex items-start">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-orange-900 mb-1">Wellness Check Recommended</h3>
              <p className="text-orange-800 mb-3">
                Your recent stress levels or burnout scores suggest you may benefit from additional support.
              </p>
              <div className="flex gap-3">
                ...
                <button className="px-4 py-2 border border-orange-600 text-orange-700 rounded-lg hover:bg-orange-50 font-medium">
                  View Resources
                </button>
              </div>
            </div>
      ...
      {!stats.has_checked_in_today && (
        <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-blue-900 mb-1">Haven't checked in today?</h3>
              <p className="text-blue-700">Take 60 seconds to log how you're feeling. It helps track your wellness trends.</p>
            </div>
            <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <h4 className="text-sm font-medium text-gray-600 mb-2">Stress Trend (7 days)</h4>
        ...
        {/* Modules Completed */}
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <h4 className="text-sm font-medium text-gray-600 mb-2">Training Modules</h4>
          <div className="flex items-baseline gap-2">
        ...
        {/* Support Circles */}
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <h4 className="text-sm font-medium text-gray-600 mb-2">Support Circles</h4>
          <div className="flex items-baseline gap-2">
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <button className="px-4 py-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 text-left">
            <div className="text-2xl mb-1">📊</div>
          ...
          <button className="px-4 py-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 text-left">
            <div className="text-2xl mb-1">🎓</div>
            <div className="font-medium text-gray-800">Training Modules</div>
      ...
      {recentCheckins.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <h3 className="text-lg font-semibold text-gray-800 mb-3">Recent Check-Ins (Last 7 Days)</h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-medium text-gray-800">
                      {new Date(checkin.checkin_date).toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric' })}
                    </div>
