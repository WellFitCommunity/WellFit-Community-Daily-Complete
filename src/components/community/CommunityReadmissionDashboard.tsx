...
function mapMemberRow(row: ViewRow): CommunityMember {
  return {
    ...
    risk_category: (row.risk_category as CommunityMember['risk_category']) ?? null,
    ...
    medication_adherence: row.medication_adherence == null ? null : Number(row.medication_adherence),
