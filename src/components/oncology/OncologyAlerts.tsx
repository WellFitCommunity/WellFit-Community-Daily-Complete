/**
 * OncologyAlerts - Renders oncology clinical alerts by severity
 */

import React from 'react';
import type { OncAlert, OncAlertSeverity } from '../../types/oncology';

interface OncologyAlertsProps {
  alerts: OncAlert[];
}

const SEVERITY_STYLES: Record<OncAlertSeverity, { bg: string; text: string; border: string; icon: string }> = {
...
const OncologyAlerts: React.FC<OncologyAlertsProps> = ({ alerts }) => {
  if (alerts.length === 0) {
    return (
