/**
 * Marker Priority Scoring - Priority weights and scoring for thumbnail display
 *
 * Determines which markers are most important to show in limited space.
 * Used by AvatarThumbnail and other summary views.
 */

import type { MarkerTypeDefinition } from '../../../types/patientAvatar';
import { getMarkerTypeDefinition } from './markerTypeLookup';
...
// Re-export getMarkerTypeDefinition for consumers that imported from markerPriority
export type { MarkerTypeDefinition };
