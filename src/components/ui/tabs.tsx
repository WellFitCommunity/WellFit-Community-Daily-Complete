...
function TabsTrigger({ className, value: triggerValue, ref, ...props }: TabsTriggerProps) {
...
function TabsContent({ className, value: contentValue, ref, ...props }: TabsContentProps) {
  const context = React.useContext(TabsContext);
  if (!context) {
