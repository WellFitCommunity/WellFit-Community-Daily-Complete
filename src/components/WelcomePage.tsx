...
const WelcomePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-8 text-center bg-gradient-to-b from-[#003865]/20 to-[#8cc63f]/30 text-[#003865]">
      <img
      ...
      <div className="mt-6">
        <button
          ...
          className="px-6 py-3 bg-[#8cc63f] hover:bg-[#003865] text-white font-semibold rounded-xl shadow-md transition"
        >
          Continue
        </button>
      </div>
