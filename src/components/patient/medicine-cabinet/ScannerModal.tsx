        ...
        {!processing ? (
          <div className="space-y-4">
            <div className="border-2 border-dashed border-gray-300 dark:border-slate-600 rounded-xl p-8 text-center">
              ...
              <p className="text-gray-600 dark:text-slate-400 mb-4">Take a clear photo of the medication label</p>
              <input
                type="file"
                accept="image/*"
                capture="environment"
            ...
            <button
              onClick={onClose}
              className="w-full bg-gray-200 text-gray-700 dark:text-slate-300 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors"
            >
              Cancel
            </button>
          </div>
          ...
          <div className="py-8">
            ...
            <p className="text-center text-gray-700 dark:text-slate-300 mb-4">AI is reading the label...</p>
            ...
            <p className="text-center text-sm text-gray-500 dark:text-slate-400 mt-2">{uploadProgress}%</p>
          </div>
        )}
      </div>
    </div>
