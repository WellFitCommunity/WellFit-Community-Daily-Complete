// src/serviceWorkerRegistration.ts - Enable offline support for rural healthcare
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.log('[ServiceWorker] App is being served cache-first by a service worker for offline use.');
        });
      } else {
