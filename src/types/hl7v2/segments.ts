/**
 * HL7 v2.x Segment Type Definitions
 *
 * All HL7 v2.x segment interfaces: MSH, PID, PV1, PV2, OBR, OBX, ORC,
 * DG1, AL1, IN1, NTE, MSA, ERR.
 */

import type { HL7MessageType, OBXValueType } from './core';
import type {
  PatientIdentifier,
  HumanName,
  Address,
