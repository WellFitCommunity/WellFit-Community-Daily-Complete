...
export type ServiceErrorCode =
  ...
  // Referral Letter Generator AI errors
  | 'REFERRAL_LETTER_GENERATION_FAILED'
  | 'REFERRAL_LETTER_SAVE_FAILED'
  | 'REFERRAL_LETTER_APPROVAL_FAILED'
  | 'REFERRAL_LETTER_SEND_FAILED'
  // Contraindication Detector AI errors
  | 'CONTRAINDICATION_CHECK_FAILED'
  | 'CONTRAINDICATION_SAVE_FAILED'
  | 'CONTRAINDICATION_REVIEW_FAILED'
  | 'QUICK_CHECK_FAILED'
