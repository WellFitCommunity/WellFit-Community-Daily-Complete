...
export const protectedRoutes: RouteConfig[] = [
  ...
  { path: '/devices/scale', component: 'SmartScalePage', auth: 'user', category: 'protected' },
  { path: '/devices/blood-pressure', component: 'BloodPressureMonitorPage', auth: 'user', category: 'protected' },
  { path: '/devices/glucometer', component: 'GlucometerPage', auth: 'user', category: 'protected' },
  { path: '/devices/pulse-oximeter', component: 'PulseOximeterPage', auth: 'user', category: 'protected' },
  { path: '/health-records-download', component: 'HealthRecordsDownloadPage', auth: 'user', category: 'protected' },
...
export const clinicalRoutes: RouteConfig[] = [
  ...
  {
    path: '/nurse-office',
    component: 'NurseOfficeDashboard',
    auth: 'admin',
    roles: ['admin', 'super_admin', 'nurse', 'nurse_practitioner', 'clinical_supervisor'],
    category: 'clinical',
  },
  ...
  // ONC 170.315(a)(2) — CPOE Laboratory Order Entry
  {
    path: '/admin/cpoe/lab/:patientId',
