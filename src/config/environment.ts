...
const envSchema = z.object({
  ...
  VITE_CLAUDE_DEFAULT_MODEL: z.string().default("claude-haiku-4-5-20251001"), // Fast UI/personalization
  VITE_CLAUDE_ADMIN_MODEL: z.string().default("claude-sonnet-5"), // Accurate billing/revenue
