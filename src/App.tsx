...
// App-level components (extracted for testability)
    ...
    >
      ...
      <AuthGate>
        ...
        <IdleTimeoutProvider timeoutMinutes={15} warningMinutes={2}>
          ...
          {/* Clinical users see: VoiceCommandBar, GlobalSearchBar, VoiceSearchOverlay, EASessionResume, EANotificationDock */}
