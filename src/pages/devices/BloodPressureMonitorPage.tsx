      ...
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 max-w-3xl">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl p-6 sm:p-8 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-green-50 dark:bg-slate-800 rounded-xl p-4">
            ...
            <div className="bg-yellow-50 dark:bg-slate-800 rounded-xl p-4">
              <div className="text-yellow-700 dark:text-yellow-300 font-semibold">Elevated</div>
            ...
            <div className="bg-red-50 dark:bg-red-950 rounded-xl p-4">
              <div className="text-red-700 dark:text-red-300 font-semibold">High Stage 2</div>
                  ...
                  <div key={reading.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-800 rounded-xl">
                    <div>
                      ...
                      <div className="text-2xl font-bold text-gray-800 dark:text-slate-200">
                        ...
                        <span className="text-lg font-normal text-gray-500 dark:text-slate-400 ml-2">mmHg</span>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm text-gray-500 dark:text-slate-400 mb-1">Pulse: {reading.pulse} bpm</div>
