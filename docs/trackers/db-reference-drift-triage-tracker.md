...
| get_uninvestigated_anomalies | 20251106000003 | **behavioral_anomalies MISSING** | 🏗️ | NEEDS SCHEMA REBUILD (behavioral_anomalies table + RLS). |
| get_team_time_entries | 20251201130000 | **clinician_time_tracking + time_entries MISSING** | 🏗️ | NEEDS SCHEMA REBUILD (time-clock tables). Pair w/ tenant. |
| get_tenant_time_entries | 20251201130000 | same MISSING | 🏗️ | NEEDS SCHEMA REBUILD. Pair of above. |
