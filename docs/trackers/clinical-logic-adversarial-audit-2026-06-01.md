...
- **CRITICAL** `DiagnosticReportService.ts:28,148,182` — selects `category_code`/`category_display` (don't exist; live has array `category` + `category_coding_system`) → read/create/update throw. (Same drift class as AV-3; verify.)
