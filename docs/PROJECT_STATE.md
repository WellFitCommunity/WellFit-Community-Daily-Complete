...
- **⚠️ OPEN:**
  ...
  2. **Admin product-separation Part 1** — build `useProductAccess()` + gate routes/sections/edge-fns on `licensed_products`, once Maria answers the 3 decisions in the feature-list draft + gives visual acceptance on the Part 2 section change.
